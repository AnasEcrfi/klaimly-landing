    ...
    <section className="py-20 md:py-28 bg-white">
      <div className="container mx-auto px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 gap-8">
          <div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-[#1a1a1a] max-w-2xl leading-[1.1] mb-8">
          ...
          <Link
            href="/services"
            className="group inline-flex items-center gap-3 bg-gradient-to-r from-[#7A866C] via-[#869271] to-[#93A084] text-white px-8 py-4 rounded-full hover:from-[#6B7760] hover:via-[#778366] hover:to-[#849175] transition-all duration-300 hover:shadow-xl hover:scale-105"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-0">
            ...
            <div className="flex gap-6 mb-10">
              <div
                ref={counterRef}
                className="bg-gradient-to-br from-[#7A866C] via-[#748060] to-[#6B7760] text-white p-8 rounded-xl min-w-[140px] shadow-xl"
              >
                ...
                <p className="text-white/90 text-sm">Jahre Erfahrung</p>
              </div>

              {/* Small Image Card */}
              <div className="flex-1 h-[160px] rounded-xl overflow-hidden bg-gray-100">
                ...
                >
                  <div className="flex items-center justify-between py-5 relative">
                    <div className="flex items-center gap-8">
                      ...
                      <h3 className={`text-xl font-medium transition-all ${
          ...
          {/* Right Column - Image */}
          <div className="relative h-[500px] lg:h-[600px] rounded-3xl overflow-hidden bg-gray-50">
            {tabs.map((_, index) => (
              <div
                key={index}
              ...
              >
                <div className="w-full h-full flex items-center justify-center p-12">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-light text-[#1a1a1a] mb-4">{tabs[activeTab].title}</h3>
                    <p className="text-[#1a1a1a]/60 text-base max-w-md mx-auto">{tabs[activeTab].description}</p>
                  </div>
                </div>
              </div>
            ))}

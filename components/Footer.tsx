        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-16">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/company/klaimly" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors duration-300">

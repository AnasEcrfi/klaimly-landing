  ...
  return (
    <footer className="bg-gradient-to-b from-[#7A866C] via-[#748165] to-[#6E785F] text-white">
      <div className="max-w-7xl mx-auto px-8 py-20">
        ...
        {/* Logo */}
        <div className="mb-16">
          <span className="text-4xl font-light text-white/90 tracking-wider">KLAIMLY</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 mb-4 md:mb-0">
            ...
            <div className="flex items-center gap-1">
              <span className="text-white/60 text-xs">Designed by</span>
              <a
                href="https://www.mpagency.ae"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 hover:text-white transition-colors duration-300 text-xs font-medium"
              >
                MP-Agency
              </a>
            </div>
          ...
          <div className="flex gap-6">
            <Link href="/datenschutz" className="text-white/60 hover:text-white transition-colors duration-300 text-xs">Datenschutz</Link>
            <Link href="/impressum" className="text-white/60 hover:text-white transition-colors duration-300 text-xs">Impressum</Link>
          </div>
        </div>
      </div>
    </footer>
